...
export default class AppLoggerService extends ConsoleLogger {
  ...
  verbose(message: any, ...optionalParams: any[]) {
    ...
    if (this.isLevelEnabled('verbose') === false)
      return ;
  ...
  log(message: any, ...optionalParams: any[]) {
    ...
    if (this.isLevelEnabled('log') === false)
      return ;
  ...
  warn(message: any, ...optionalParams: any[]) {
    ...
    if (this.isLevelEnabled('warn') === false)
      return ;
  ...
  error(message: any, ...optionalParams: any[]) {
    ...
    if (this.isLevelEnabled('error') === false)
      return ;
  ...
  fatal(message: any, ...optionalParams: any[]) {
    ...
    if (this.isLevelEnabled('fatal') === false)
      return ;
