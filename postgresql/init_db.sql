...
CREATE TABLE IF NOT EXISTS Games (
		...
		sender_id INTEGER NOT NULL CHECK (sender_id > 0),
		receiver_id INTEGER NOT NULL CHECK (sender_id > 0),
		custom BOOLEAN NOT NULL DEFAULT false,
		score_sender INTEGER NOT NULL DEFAULT 0 CHECK (score_sender >= 0),
		score_receiver INTEGER NOT NULL DEFAULT 0 CHECK (score_receiver >= 0),
