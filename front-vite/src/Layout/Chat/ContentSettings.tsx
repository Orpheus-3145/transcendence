		...
		>
			<Stack direction={'column'} sx={{ flexGrow: 1, maxHeight: '100%' }}>
				<Stack
					direction={'row'}
					onClick={() => {
						toggleChatStatus(ChatStatus.Chatbox, chatProps.selected);
					}}
					sx={{
						position: 'sticky',
						top: 0,
				...
				>
					...
					<Stack direction='column' spacing={2}>
						...
						>
							<Stack direction={'row'} spacing={1} gap={0} paddingX={'0.5em'}>
								<Typography alignSelf={'center'} color={(theme) => theme.palette.secondary.main}>
									Type:
								</Typography>
					...
					>
						<Typography alignContent={'center'} variant='h6' color='primary' fontSize={'1em'}>
							Channel Owner:
						</Typography>
						<Typography
							alignContent={'center'}
					...
					>
						...
						>
							<AddIcon />
							<Typography alignSelf={'center'} fontSize={'0.7em'}>
								Add a friend
							</Typography>
						</IconButton>
