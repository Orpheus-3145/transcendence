...
const ChannelsPage: React.FC = () => {
		...
		return (
			<Stack
				...
				sx={{
					...
					cursor: 'pointer',
					transition:
						'padding-left ease-in-out 0.3s, padding-right ease-in-out 0.3s, border-radius ease-in-out 0.3s, background-color ease-in-out 0.3s',
					'&:hover': {
	...
	let channelCreationSection = () => {
		return (
			<Box height={'80vh'} bgcolor={theme.palette.primary.light}>
		...
		return (
			<Container sx={{ padding: theme.spacing(3) }}>
				...
				>
					...
					<Stack width={'100%'}>{channelCreationSection()}</Stack>
				</Stack>
			</Container>
		);
	};
